...
public class Cadastrar extends JFrame {
	...
	public Cadastrar () {
		...
		criarBotao("Cadastrar Área de Abrangência", new ButtonAreaAbrangenciaHandler());
		criarBotao("Cadastrar Curso", new ButtonCursoHandler());
		criarBotao("Cadastrar Funcionário", new ButtonFuncionarioHandler());
		criarBotao("Cadastrar Instituição", new ButtonInstituicaoHandler());
		criarBotao("Cadastrar Instrutor", new ButtonInstrutorHandler());
		criarBotao("Cadastrar Treinamento", new ButtonTreinamentoHandler());
