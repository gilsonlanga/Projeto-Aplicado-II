...
public class PesquisaNome extends JFrame {
	...
	public PesquisaNome() {
		setTitle("Pesquisa dos Treinamentos por Nome");
	...
	private class ButtonBuscarPorNomeHandler implements ActionListener {
		...
		@Override
		public void actionPerformed(ActionEvent e) {
			nomeCurso = textFieldNome.getText();
			
			criarList();
			
			
			List<Treinamento> treinamentosCarregados = treinamentoController.listarNome(nomeCurso);
